...
BUSHIDO_CONFIG_PATH="${DEPLOY_PATH}/configuration"

# SERVICE paramethers
APP_PARAM_PATH="${BUSHIDO_CONFIG_PATH}/app"
DB_PARAM_PATH="${BUSHIDO_CONFIG_PATH}/bushido_db"
WEB_SERVER_PARAM_PATH="${BUSHIDO_CONFIG_PATH}/bushido_web_server"
LIBRARY_PARAM_PATH="${BUSHIDO_CONFIG_PATH}/bushido_library"
NOKYC_PARAM_PATH="${BUSHIDO_CONFIG_PATH}/noKYC_web_server"
TOR_PARAM_PATH="${BUSHIDO_CONFIG_PATH}/tor_proxy"
DOCKER_PATH="${BUSHIDO_CONFIG_PATH}/docker"
